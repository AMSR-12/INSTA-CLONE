      ...
      <div className="row mt-5 d-flex justify-content-center">
        <div className="col-lg-6">
          <div className="border px-5">
           <img  className='img' src="https://logos-download.com/wp-content/uploads/2016/03/Instagram_Logo_2016.png"/>            <p className="text-muted my-3 ">
              Sign up to see photos and videos
              <br></br>from your friends.
            </p>
           ...
           <hr/> 
            ...
            <form action="" id="needs-validation" noValidate>
              ...
              <div className="my-3">
                <small>
                <div className="break">
                  People who use our service may have uploaded<br></br>your contact
